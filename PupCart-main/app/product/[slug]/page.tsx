...
//               {[product.image, product.image1, product.image2, product.image3].map((imgSrc, i) => (
//                 <div key={i} className="overflow-hidden rounded-lg bg-muted">
//                   <Image
//                     src={imgSrc || '/placeholder.svg?height=150&width=150'}
//                     alt={`Product view ${i}`}
//                     width={150}
//                     height={150}
//                     className="h-full w-full object-cover"
...
//   if (!resolvedParams) return null; // loading state

//   return <ProductPageInner slug={resolvedParams.slug} />;
// }
...
//     // WishlistButton handles the actual logic inside if authenticated
//   };
...
// // Set up state for selected media
...
//               // If it's a video (YouTube or external link), use iframe
//               <iframe
//                 src={selectedMedia}
//                 title="Product video"
//                 width="500"
...
//               >
//                 {i === 3 && product.video ? (
//                     <img src={product.poster} alt={${product.name} poster} width={150} height={150} className="h-full w-full object-cover rounded-lg" />
//                 ) : (
//                     <Image
//                     src={mediaSrc}
//                     alt={Product view ${i}}
